...
.word  0x1AFFFFF4 @h @ 即beq CR
ldr r0,[r6,#4]
.byte 0x59,0xF8,0xFF,0xEA @ ??? a branch 
.pool 
CartRom:
.thumb
mov r0,r0 @ 对齐
...
bx r0 
.arm 
.global OpeningReturn 
.type OpeningReturn, %function 
OpeningReturn:
mov r7,r14
push {r4-r7}
ldr r0,=0x3003000
...
stmia r0!,{r2-r7}
ldmia r1!,{r2-r6}
stmia r0!,{r2-r6} @ 将"Skip"部分到3003010
pop {r4-r7}
@mov r11, r11 
b EndOfOpeningCode
.pool
...
b OpeningReturn 
.ltorg 
.global EndOfOpeningCode
.type EndOfOpeningCode, %function 
EndOfOpeningCode: 
@ b HijackPos + 0x25C
